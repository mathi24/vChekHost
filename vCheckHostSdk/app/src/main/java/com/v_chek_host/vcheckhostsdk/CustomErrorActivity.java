...
public class CustomErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("Exception log arrived");
...
//        new SaveErrorLog(CustomErrorActivity.this).execute(logData);
        ...
        if (config.isShowRestartButton() && config.getRestartActivityClass() != null) {
            ...
            restartButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i=getIntent();
//                    new Intent(CustomErrorActivity.this, LoginActivity.class);
                    ComponentName c=new ComponentName(CustomErrorActivity.this, VinNumberActivity.class);
                    i.setComponent(c);
                    startActivity(i);
//                    CustomActivityOnCrash.closeApplication(CustomErrorActivity.this, config);
    ...
    private static class SaveErrorLog extends AsyncTask<String, Integer, String> {
        private WeakReference<CustomErrorActivity> activityRef;

        private SaveErrorLog(CustomErrorActivity activity) {
