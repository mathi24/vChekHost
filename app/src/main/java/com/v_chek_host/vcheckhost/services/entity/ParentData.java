...
public class ParentData implements Serializable {
    ...
    public  ParentData(MetaData metaData,PrimaryData primaryData){
    ...
    public static class PrimaryData implements Serializable{
    ...
    public static class PrimaryParams implements Serializable{
