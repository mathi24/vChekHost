...
public class TrainCamera2ConnectionFragment extends Fragment {
  ...
  @SuppressLint("ValidFragment")
  private TrainCamera2ConnectionFragment(
  ...
  public static TrainCamera2ConnectionFragment newInstance(
          final ConnectionCallback callback,
          final OnImageAvailableListener imageListener,
          final int layout,
          final Size inputSize) {
    return new TrainCamera2ConnectionFragment(callback, imageListener, layout, inputSize);
  }
  ...
  /** Opens the camera specified by {@link TrainCamera2ConnectionFragment#}. */
